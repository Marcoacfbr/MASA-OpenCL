...
private:
	 ...
	 * @see CUDAligner::load_column() method.
	 */
	cell_t*  h_loadColumn;

	/**
	 * Number of CUDA blocks effectively running.
	 * This number is less than MAX_BLOCKS
	 * and than CUDAlignerParameters::blocks.
	 */
	int gridWidth;
	...
	/** Maintains the minimum CUDAligner::gridWidth size used. */
	int statMinGridWidth;
	/** Maintains the maximum CUDAligner::gridWidth size used. */
