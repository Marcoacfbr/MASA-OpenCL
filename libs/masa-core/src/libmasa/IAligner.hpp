...
public:
		 ...
		 * AbstractAlignerParameters class is used by MASA to present
		 ...
		 * AbstractAlignerParameters class, otherwise the behavior of the
		 * entire MASA-Core may be compromised.
		 *
		 *
		 * @return The customized parameters for this IAligner.
		 *
		 * @see The AbstractAlignerParameters class presents the details
		 * to customize these parameters.
		 */
		virtual AbstractAlignerParameters* getParameters() = 0;
