...
/*
 * The OpenCLAligner class is the Aligner implementation of the MASA-CUDAlign
...
typedef struct {
	 ...
	 * @see OpenCLAligner::loadLastRow and kernel_flush methods
	 */
	int2* h_extraH;
	/**
	 ...
	 * @see OpenCLAligner::getLastColumn() method.
	 */
...
typedef struct {
	...
	cl_mem d_extraH;
	/** Equivalent vector of host_structures_t::h_flushColumnH */
	cl_mem d_flushColumnH;
	/** Equivalent vector of host_structures_t::h_flushColumnE */
	cl_mem d_flushColumnE;
	/** Equivalent vector of host_structures_t::h_loadColumnH */
	cl_mem d_loadColumnH;
	/** Equivalent vector of host_structures_t::h_loadColumnE */
	cl_mem d_loadColumnE;
	/** Equivalent vector of host_structures_t::h_blockResult */
	cl_mem d_blockResult;
	/** CUDA vector storing the H components of the vertical bus */
	cl_mem d_busV_h;
	/** CUDA vector storing the E components of the vertical bus */
	cl_mem d_busV_e;
	...
	/** Size allocated for the d_busH vector */
	int busH_size;
	cl_context glcontext;
	cl_device_id gldevice;
	cl_uint glnumdevices;
	cl_program glprogram;
	cl_command_queue glcommand;
 ...
 */
class OpenCLAligner : public AbstractDiagonalAligner {
...
private:
	...
	OpenCLAlignerParameters* params;
	...
	void clallocateGlobalStructures();
	void freeGlobalStructures();
	void clfreeGlobalStructures();
...
/*
 * The following methods are wrappers for the OpenCLAligner.cu source file.
 */
